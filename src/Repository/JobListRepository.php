...
/**
 * @extends ServiceEntityRepository<JobList>
 *
...
class JobListRepository extends ServiceEntityRepository
{
    ...
    public function save(JobList $entity, bool $flush = false): void
    {
    ...
    public function remove(JobList $entity, bool $flush = false): void
    {
...
//    /**
//     * @return JobList[] Returns an array of JobList objects
//     */
...
//    public function findOneBySomeField($value): ?JobList
//    {
//        return $this->createQueryBuilder('j')
//            ->andWhere('j.exampleField = :val')
//            ->setParameter('val', $value)
